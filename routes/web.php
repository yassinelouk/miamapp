...
Route::middleware(['setlang'])->group(function () {
    ...
    Route::post('/job/apply', 'Front\FrontendController@JobApplicationStore')->name('front.job.apply');
    ...
    Route::post('/usefidelity','Front\ProductController@useFidelity')->name('front.usefidelity');
...
Route::post('/product/qrsaveorder/{status}','Payment\product\PaymentController@qrSaveOrder')->name('product.payment.qrsaveorder');
// paypal routes
...
Route::group(['prefix' => 'admin', 'middleware' => ['guest:admin','setlang']], function () {
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'setlang']], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Dashboard'], function () {
        ...
        Route::get('/dashboard/printReceipt/{order}','Admin\ProductOrderController@printReceipt')->name('admin.printReceipt');
        Route::get('/dashboard/hideOrder/{order}','Admin\ProductOrderController@hideOrder')->name('admin.hideOrder');
    });

    Route::post('/session-variable', 'Admin\DashboardController@createSessionVariable')->name('admin.sessionVariable');
    ...
    Route::group(['middleware' => 'checkpermission:Website Pages'], function () {
        ...
        Route::get('/job/applications', 'Admin\JobController@jApplicationsIndex')->name('admin.job.applications');
        Route::post('/job/applications/delete', 'Admin\JobController@jApplicationsDelete')->name('admin.job.applications.delete');
        Route::get('/job/applications/{id}/details', 'Admin\JobController@jApplicationsDetails')->name('admin.job.applications.details');
    ...
    Route::group(['middleware' => 'checkpermission:Product Management'], function () {
        ...
        Route::post('/category/update-positions', 'Admin\ProductCategory@updatePositions')->name('admin.category.update.positions');
        ...
        Route::get('/product/{id}/duplicate', 'Admin\ProductController@duplicate')->name('admin.product.duplicate');
    ...
    Route::group(['middleware' => 'checkpermission:Order Management'], function () {
        ...
        Route::post('/ordertime/store', 'Admin\ProductOrderController@orderTimeStore')->name('admin.ordertime.store');
        Route::post('/ordertime/delete', 'Admin\ProductOrderController@orderTimeDelete')->name('admin.ordertime.delete');
        ...
        Route::get('/order/update/{sub_order_id}/{state}', 'Admin\ProductOrderController@updateSubOrderState')->name('admin.order.update.state');
        Route::post('/order/change-table', 'Admin\ProductOrderController@updateOrderTable')->name('admin.order.changeTable');
        Route::post('/order/transfert-product', 'Admin\ProductOrderController@transferProducts')->name('admin.order.transferProducts');
        Route::post('/order/delete-product-item', 'Admin\ProductOrderController@deleteProductItem')->name('admin.orderitem.delete');
    ...
    Route::group(['middleware' => 'checkpermission:Customers'], function () {
        ...
        Route::get('/customer/fidelity', 'Admin\CustomerController@fidelityIndex')->name('admin.customer.fidelity');
        Route::post('/customer/fidelity/times', 'Admin\CustomerController@updateFidelitytime')->name('admin.fidelitytime.update');
        Route::post('/customer/fidelity/update','Admin\CustomerController@updateFidelityStatus')->name('admin.fidelity.update');
        //Customers end
    ...
    Route::group(['middleware' => 'checkpermission:Tables & QR Builder'], function () {
        ...
        Route::post('/table/assign-waiter', 'Admin\TableController@assignWaiter')->name('admin.table.assignWaiter');
    });
