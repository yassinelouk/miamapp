...
class ForgotController extends Controller
{
    ...
    public function forgot(Request $request)
    {
        ...
        if (User::where('email', '=', $request->email)->count() > 0) {
            ...
            Session::flash('success', __('Your Password has been reset successfully. Please Check your email for new Password'));
            return back();
        } else {

            // user not found
            Session::flash('err', __('No Account Found With This Email'));
            return back();
        }
    }
}
