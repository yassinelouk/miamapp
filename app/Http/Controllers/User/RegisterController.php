...
class RegisterController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        return back()->with('sendmail', __('We need to verify your email address. We have sent an email to :email to verify your email address. Please click link in that email to continue', ['email' => $request->email]));
        }
