...
class JobController extends Controller
{
    ...
    public function jApplicationsIndex(Request $request)
    {
        $lang = Language::where('code', $request->language)->first();

        $lang_id = $lang->id;
        $data['jobs_applications'] = Japplications::where('language_id', $lang_id)->orderBy('id', 'DESC')->get();

        return view('admin.job.job.applications', $data);
    }
    ...
    public function jApplicationsDetails($id) {
        $data['job_app'] = Japplications::findOrFail($id);
        return view('admin.job.job.applications-details', $data);
    }
    ...
    public function jApplicationsDelete(Request $request) {
        $job_app = Japplications::findOrFail($request->job_app_id);
        @unlink('assets/admin/cvs/' . $job_app->cv_name);
        $job_app->delete();

        Session::flash('success', 'Applications successfully deleted!');
        return back();
    }
