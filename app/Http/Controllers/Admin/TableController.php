...

{
    ...
    public function index()
    {
        ...
        $data['user'] = Auth::user();
        $data['waiters'] = Admin::where('role_id', 10)->get();
...
@mkdir($directory, 0775, true);
    ...
    public function assignWaiter(Request $request) {
        ...
        $table->assigned_waiter = $request->waiter_id;
        $table->save();
    ...
    public function delete(Request $request)
    {
        ...
        $orders = ProductOrder::where('table_number',$table->table_no)->where('completed','no')->get();
