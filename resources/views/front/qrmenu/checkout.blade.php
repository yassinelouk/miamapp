...
<section class="checkout-area">
    <form action="" method="POST" id="payment" enctype="multipart/form-data">
        ...
        <div class="container">
            ...
            @endphp
            <input type="hidden" name="table_number" value="{{$table}}" autocomplete="off">
            <h2 class="check-out-table"> {{ __('Table') }} {{$table}}</h2>
                        <button type="button" class="main-btn {{$rtl == 1 ? 'text-right float-left ' : 'text-left float-right '}}" id="sendOrderBtn"><span
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="table">
                            ...
                            <div class="text-center my-4">
                                <a href="{{ route('front.qrmenu',['table'=>$table]) }}"
...
@includeIf('front.qrmenu.partials.checkout-modal')
