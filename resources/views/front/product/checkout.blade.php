                                    ...
                                    @foreach ($smethods as $sm)
                                        <tr>
                                            <td>
                                                ...
                                                @if($sm->value == 'home_delivery')
                                                <!--<i style="font-size: 2rem; margin-left:25%;" class="fas fa-shipping-fast"></i>-->
                                                <img style="margin-left:25%;" src="{{asset('assets/front/img/foodscoot.svg')}}"/>
                                                @endif
                                                @if($sm->value == 'pick_up')
                                                <!--<i style="font-size: 2rem; margin-left:25%;" class="fas fa-people-carry"></i>-->
                                                <img style="margin-left:25%;" src="{{asset('assets/front/img/foodbag.svg')}}"/>
                                                @endif
                                            </td>
                                            <td>
                                                <p class="mb-1"><strong>{{ __($sm->name)  }}</strong></p>
                                                <p class="mb-0"><small>{{ __('note ' . $sm->name)}} </small></p>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            ...
                            @includeIf('front..partials.order_total_web')
                        </div>
                    </div>
                </div>
            </div>
