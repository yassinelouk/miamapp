...
<head>
    ...
    <style>
        ...
        .go-top-area .go-top.active.cart-volatil {
            top: calc(98% - 80px);
        }
        .go-top-area .go-top.active.cart-volatil i {
            opacity: 1;
            visibility: visible;
            top: 50%;
        }
    ...
    .good-food-area.pt-180.pb-120.gray-bg{
            background: #080705;
    }
  </style>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 order-3 order-lg-2">
                        <div class="footer-widget-2 text-left text-sm-center" >
                            ...
                            <a class="pt-30" href="{{route('front.index')}}">
    ...
    <div class="go-top-area">
        <div class="go-top-wrap">
            <div class="go-top-btn-wrap">
                <div class="go-top go-top-btn cart-volatil">
                    <a href="{{route('front.cart')}}">
                      <i class="fas fa-cart-plus"></i>
                    </a>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="callWaiterForm" action="{{route('front.callwaiter')}}" method="GET">
                        <select class="form-control" name="table" disabled required>
                            <option value="{{ session()->get('id_table')}}">{{__('Table')}} - {{ session()->get('id_table') }} </option>
                        </select>
                    </form>
                </div>
