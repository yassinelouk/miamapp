                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="tabs-btn pb-20">
                                <ul class="nav nav-pills d-flex justify-content-center owl_1 owl-carousel owl-theme" id="pills-tab" role="tablist">
                                    ...
                                    <div class="food-menu-items menu-2">
                                        ...
                                        <div class="single-menu-item mt-30">
                                            ...
                                            <div class="menu-price-btn menu-2">
                                                ...
                                                <a class="cart-link" data-product="{{$product}}" data-href="{{route('add.cart',$product->id)}}"><i class="fas fa-plus"></a>
                                            </div>
                                            @if ($product->is_special == 1)
                                            <div class="flag flag-2"><span>{{__('Special')}}</span></div>
                                            @endif
