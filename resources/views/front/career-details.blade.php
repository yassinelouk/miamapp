...
@section('content')
        ...
        <div class="row">
           <div class="col-lg-7">
              <div class="job-details">
                ...
                @endif
                <div class="info">
                    <strong class="label">{{__('Send message')}}</strong>
                    <div class="desc">
                        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#postulateModal"><i class="fas fa-paper-plane"></i> {{__('Postulate')}}</a>
                    </div>
                </div>
              </div>
           </div>
  ...
  @includeif('front.partials.postulate_modal')
