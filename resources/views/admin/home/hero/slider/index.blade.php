        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-4 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-lg-right float-left" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{__('add new')}}</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                  ...
                  @foreach ($sliders as $key => $slider)
                    <div class="col-md-3">
                      <div class="card">
        				...
        				<div class="card-footer d-flex aign-items-center">
        ...
        <div class="modal-body">
          <form class="modal-form" id="ajaxForm" action="{{route('admin.slider.store')}}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{__('Title')}}: {{__('Font Size')}} **</label>
                      <input type="number" class="form-control ltr" name="title_font_size" value="" placeholder="{{__('Font Size')}}...">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="text" value="" placeholder="{{__('Text')}}...">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="text_font_size" value="" placeholder="{{__('Font Size')}}...">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control ltr" name="button_text_font_size" value="" placeholder="{{__('Font Size')}}...">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="button_text1"  placeholder="{{__('Text')}}...">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control ltr" name="button_url1"  placeholder="URL ...">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control ltr" name="button_text1_font_size"  placeholder="{{__('Font Size')}}...">
