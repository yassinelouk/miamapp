    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{__('Edit')}}: {{__('Sliders')}}</div>
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.slider.update')}}" method="post">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong>{{__('Slider Images')}}</strong></label>
                      </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="title" value="{{$slider->title}}" placeholder="{{__('Title')}}...">
                          <p id="errtitle" class="text-danger mb-0 em"></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                          <label>{{__('Title')}}: {{__('Font Size')}} **</label>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="text" value="{{$slider->text}}" placeholder="{{__('Text')}}...">
                          <p id="errtext" class="text-danger mb-0 em"></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="">{{__('Text')}}: {{__('Font Size')}} **</label>
                            <input type="text" class="form-control ltr" name="text_font_size" value="{{$slider->text_font_size}}" placeholder="{{__('Font Size')}}">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                          <label for="">{{__('Button')}} 1: {{__('Text')}}</label>
                          <input type="text" class="form-control" name="button_text" value="{{$slider->button_text}}" placeholder="{{__('Text')}}...">
                          <p id="errbutton_text" class="text-danger mb-0 em"></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                          <label for="">{{__('Button')}} 1: {{__('Text')}}, {{__('Font Size')}} **</label>
                          <input type="text" class="form-control ltr" name="button_text_font_size" value="{{$slider->button_text_font_size}}" placeholder="{{__('Font Size')}}...">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                          <label for="">{{__('Button')}} 1: URL</label>
                          <input type="text" class="form-control ltr" name="button_url" value="{{$slider->button_url}}" placeholder="URL ...">
                          <p id="errbutton_url" class="text-danger mb-0 em"></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                          <label>{{__('Button')}} 1: {{__('Color')}} **</label>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                          <label for="">{{__('Button')}} 2: {{__('Text')}}</label>
                          <input type="text" class="form-control" name="button_text1" value="{{$slider->button_text1}}" placeholder="{{__('Text')}}...">
                          <p id="errbutton_text1" class="text-danger mb-0 em"></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                          <label for="">{{__('Button')}} 2: {{__('Text')}}, {{__('Font Size')}} **</label>
                          <input type="text" class="form-control ltr" name="button_text1_font_size" value="{{$slider->button_text1_font_size}}" placeholder="{{__('Font Size')}}...">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          <label for="">{{__('Button')}} 2: URL</label>
                          <input type="text" class="form-control ltr" name="button_url1" value="{{$slider->button_url1}}" placeholder="URL ...">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control ltr" name="serial_number" value="{{$slider->serial_number}}" placeholder="{{__('Serial Number')}}...">
