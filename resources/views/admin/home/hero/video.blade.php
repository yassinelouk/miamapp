    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-title">{{__('Update')}}: {{__('Video Link')}}</div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.herosection.video.update')}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <p class="text-warning mb-0">{{__('Link will be formatted automatically after submitting form')}}.</p>
