    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Update')}}: {{__('Hero Section')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
            ...
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxForm" action="{{route('admin.herosection.update', $lang_id)}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="">{{__('Bold Text')}}: {{__('Font Size')}} **</label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="">{{__('Bold Text')}}: {{__('Color')}}</label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="">{{__('Text')}}: {{__('Color')}}</label>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="">{{__('Button')}} 1: {{__('Color')}}</label>
