...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Text & Image')}}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Update')}} : {{__('Text & Image')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <div class="showImage mb-3">
                        ...
                        @endif
                        <img src="{{ !empty($abe->table_section_img) ? asset('assets/front/img/'.$abe->table_section_img) : asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail breadcumb">
                      </div>
