      ...
      <div class="card">
        <form action="{{route('admin.feature.update')}}" method="post" enctype="multipart/form-data">
          <div class="card-header">
            <div class="card-title d-inline-block">{{__('Edit')}}: {{__('Features')}}</div>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="title" placeholder="{{__('Title')}}..." value="{{$feature->title}}">
                    @if ($errors->has('title'))
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control ltr" name="serial_number" value="{{$feature->serial_number}}" placeholder="{{__('Serial Number')}}...">
