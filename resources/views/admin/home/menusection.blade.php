    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Update')}}: {{__('Menu Section')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <div class="showImage mb-3">
                        ...
                        @endif
                        <img src="{{ !empty($abe->menu_section_img) ? asset('assets/front/img/'.$abe->menu_section_img) : asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail breadcumb">
                      </div>
                      ...
                      <p class="text-warning">{{__('This background is shown in menu version 2')}}</p>
                    </div>
                  </div>
                </div>

                <div class="form-group">
                    <label class="form-label">{{__('Menu Version')}} **</label>
                    <div class="row">
