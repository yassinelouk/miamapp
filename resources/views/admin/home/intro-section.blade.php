    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Update')}}: {{__('Intro Section')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.introsection.update', $lang_id)}}" method="post">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-12 showImage mb-3">
                        <img src="{{$abs->intro_main_image ? asset('assets/front/img/'.$abs->intro_main_image) : asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail breadcumb">
                      </div>
                ...
                <div class="form-group">
                  <label for="">{{__('Intro Section')}}: {{__('Title')}}</label>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label for="image" class="d-block"><strong>{{__('Signature')}}</strong></label>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong>{{__('Video Background')}}</strong></label>
                      </div>
                      <div class="col-md-12 intro_video_image mb-3">
                        <img src="{{ $abs->intro_video_image ? asset('assets/front/img/'.$abs->intro_video_image) :  asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail breadcumb">
                      </div>
                ...
                <div class="form-group">
                  <label for="">{{__('Contact')}}: {{__('Text')}} </label>
