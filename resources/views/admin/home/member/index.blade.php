    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Title')}} & {{__('Subtitle')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="team_section_title" value="{{$abs->team_section_title}}" placeholder="{{__('Title')}}...">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="team_section_subtitle" value="{{$abs->team_section_subtitle}}" placeholder="{{__('Subtitle')}}...">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{route('admin.member.create') . '?language=' . request()->input('language')}}" class="btn btn-primary float-right"><i class="fas fa-plus"></i> {{__('add new')}}</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
                      ...
                      @foreach ($members as $key => $member)
                        <tr>
                          ...
                          <td>
                            ...
                            <select class="form-control form-control-sm form-rounded border-0 text-light w-auto {{$member->feature == 1 ? 'bg-success' : 'bg-danger'}}" name="feature" onchange="document.getElementById('featureForm{{$member->id}}').submit();">
                          ...
                          <td class="d-flex align-items-center" >
                            ...
                            <form class="d-inline-block" action="{{route('admin.member.delete')}}" method="post">
                              @csrf
                              <input type="hidden" name="member_id" value="{{$member->id}}">
