    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Update')}}: {{__('Special Section')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <div class="showImage mb-3">
                        <img src="{{ !empty($abe->special_section_bg) ? asset('assets/front/img/'.$abe->special_section_bg) : asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail breadcumb">
                      </div>
