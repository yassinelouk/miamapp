...
@section('content')
  ...
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        ...
        <a href="#">{{__('Table')}} - {{$table->table_no}}</a>
  ...
  <div class="row">
              ...
              <form id="qrGeneratorForm" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <select name="style" class="form-control" onchange="generateQr()">
                          ...
                          <option value="square" {{$table->style == 'square' ? 'selected' : ''}}>{{__('Square')}}</option>

                          <option value="round" {{$table->style == 'round' ? 'selected' : ''}}>{{__('Round')}}</option>
                  ...
                  <div class="form-group">
                      ...
                      <select name="eye_style" class="form-control" onchange="generateQr()">
                          ...
                          <option value="square" {{$table->eye_style == 'square' ? 'selected' : ''}}>{{__('Square')}}</option>

                          <option value="circle" {{$table->eye_style == 'circle' ? 'selected' : ''}}>{{__('Round')}}</option>
                  ...
                  <div class="form-group">
                      ...
                      <select name="type" class="form-control" onchange="generateQr()">
                          ...
                          <option value="default" {{$table->type == 'default' ? 'selected' : ''}}>{{__('Default')}}</option>
                          <option value="image" {{$table->type == 'image' ? 'selected' : ''}}>{{__('Image')}}</option>
                          <option value="text" {{$table->type == 'text' ? 'selected' : ''}}>{{__('Text')}}</option>
                  ...
                  <div id="type-image" class="types">
                      ...
                      <div class="form-group">
                          ...
                          <label for="">{{__('Image')}}: {{__('Horizontal Poistion')}}</label>
    ...
    <div class="col-lg-5">
        <div class="card bg-white">
            ...
            <div class="card-footer text-center" style="border-top: 1px solid #ebecec!important;">
              <a id="downloadBtn" class="btn btn-success" download="qr-image.png" href="{{asset('assets/admin/img/tables/' . $table->qr_image)}}">{{__('Download')}}</a>
            </div>
        </div>
    ...
    <div class="col-lg-4" style="display:none;">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title d-flex justify-content-between"><span>{{__('Included QR Code Banners')}} (PSDs)</span> <a class="btn btn-success" href="{{asset('assets/admin/img/qr_banners/QR_Banners_PSDs.zip')}}" download="qr_banners_psds.zip">{{__('Download')}}</a></h5>
          </div>
          <div class="card-body">
