            ...
            <div class="row">
              <div class="col-lg-8 offset-lg-2">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="button_url" value="" placeholder="URL...">
                    @if ($errors->has('button_url'))
                    <p class="text-danger mb-0">{{$errors->first('button_url')}}</p>
                    @endif
                    <p class="mb-0 text-warning">{{__('Only users who have allowed notifications will receive it')}}.</p>
