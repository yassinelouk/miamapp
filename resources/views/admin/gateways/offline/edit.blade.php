    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
       <div class="modal-content">
          <div class="modal-header">
             <h5 class="modal-title" id="exampleModalLongTitle">{{__('Edit')}} {{__('Payment Gateways')}}</h5>
          ...
          <div class="modal-body">
             <form id="ajaxEditForm" class="" action="{{route('admin.gateway.offline.update')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="inshort_description" class="form-control" name="short_description" rows="3" cols="80" placeholder="{{__('Description')}}..."></textarea>
                    <p id="eerrshort_description" class="mb-0 text-danger em"></p>
                 </div>

                 <div class="form-group">
                    <label for="">{{__('Instructions')}}</label>
                    <textarea id="ininstructions" class="form-control summernote" name="instructions" rows="3" cols="80" placeholder="{{__('Instructions')}}..." data-height="150"></textarea>
                 </div>

                 <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label>{{__('Receipt')}}: {{__('Image')}} **</label>
