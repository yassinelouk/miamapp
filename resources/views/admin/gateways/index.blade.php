          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-12">
                ...
                @endphp
                <div class="form-group">
                  <label>Paypal {{__('Test Mode')}}</label>
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    <label>Paytm {{__('Merchant Key')}}</label>
                ...
                <div class="form-group">
                    <label>Paytm {{__('Merchant')}} mid</label>
                ...
                <div class="form-group">
                    <label>Paytm {{__('Merchant')}} website</label>
          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    <label>Instamojo API {{__('Key')}}</label>
                ...
                <div class="form-group">
                    <label>Instamojo {{__('Auth Token')}}</label>
          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    <label>Paystack {{__('Secret Key')}}</label>
          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    <label>Flutterwave {{__('Public Key')}}</label>
                ...
                <div class="form-group">
                    <label>Flutterwave {{__('Secret Key')}}</label>
        ...
        <div class="card">
            ...
            <div class="card-body pt-5 pb-5">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <label>Mollie Payment {{__('Key')}}</label>
            ...
            <div class="card-body pt-5 pb-5">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            <label>PayUmoney {{__('Merchant Key')}}</label>
