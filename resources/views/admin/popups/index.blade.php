    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">{{__('Announcement Popup')}}</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="{{route('admin.popup.types')}}" class="btn btn-primary float-right btn-sm"><i class="fas fa-plus"></i> {{__('add new')}}</a>
              ...
              @else
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="text-dark">
                            {{__('All activated popups will be shown in website according to their Serial Number')}}
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <form id="statusForm{{$popup->id}}" class="d-inline-block" action="{{route('admin.popup.status')}}" method="post">
                                ...
                                <select class="form-control form-control-sm w-auto p-2
                                @if ($popup->status == 1)
                                  bg-success
                          ...
                          <td class="d-flex align-items-center" >
                            ...
                            <form class="d-inline-block" action="{{route('admin.popup.delete')}}" method="post">
                              @csrf
                              <input type="hidden" name="popup_id" value="{{$popup->id}}">
