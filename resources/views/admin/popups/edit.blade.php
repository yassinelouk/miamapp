                        ...
                        <form id="ajaxForm" class="modal-form" action="{{route('admin.popup.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            @if ($type == 1 || $type == 4 || $type == 5 || $type == 7)
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning mb-0">{{__('JPG, PNG, JPEG image is allowed')}}</p>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{$popup->name}}" placeholder="{{__('Name')}}...">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{$popup->title}}" placeholder="{{__('Title')}}...">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="text" cols="30" rows="3" placeholder="{{__('Text')}}...">{{$popup->text}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control ltr datepicker" name="end_date" value="{{$popup->end_date}}" placeholder="{{__('End Date')}}..." autocomplete="off">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control ltr timepicker" name="end_time" value="{{$popup->end_time}}" placeholder="{{__('End Time')}}..." autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control ltr" name="background_opacity" value="{{$popup->background_opacity}}" placeholder="{{__('Opacity')}}...">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="button_text" value="{{$popup->button_text}}" placeholder="{{__('Text')}}...">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control jscolor ltr" name="button_color" value="{{$popup->button_color}}" placeholder="{{__('Color')}}...">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control ltr" name="button_url" value="{{$popup->button_url}}" placeholder="URL...">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control ltr" name="delay" value="{{$popup->delay}}" placeholder="{{__('Delay (miliseconds)')}}...">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control ltr" name="serial_number" value="{{$popup->serial_number}}" placeholder="{{__('Serial Number')}}...">
