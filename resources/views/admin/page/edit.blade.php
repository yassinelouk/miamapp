    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{__('Edit')}}: {{__('Pages')}}</div>
            ...
            <div class="col-lg-10 offset-lg-1">
              <form id="ajaxForm" action="{{route('admin.page.update')}}" method="post">
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" placeholder="{{__('Name')}}..." value="{{$page->name}}">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" placeholder="{{__('Title')}}..." value="{{$page->title}}">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="subtitle" placeholder="{{__('Subtitle')}}..." value="{{$page->subtitle}}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control ltr" name="serial_number" value="{{$page->serial_number}}" placeholder="{{__('Serial Number')}}...">
                ...
                <div class="form-group">
                   ...
                   <input class="form-control" name="meta_keywords" value="{{$page->meta_keywords}}" placeholder="{{__('Keywords')}}..." data-role="tagsinput">
                </div>
                <div class="form-group">
                   <label>{{__('Description')}}</label>
                   <textarea class="form-control" name="meta_description" rows="5" placeholder="{{__('Description')}}...">{{$page->meta_description}}</textarea>
                </div>
              </form>
