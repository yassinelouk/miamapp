...
<div class="card">
    ...
    <form id="ajaxForm" action="{{route('admin.reservation.form.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for=""><strong>{{__('Type')}}</strong></label>
            <div class="">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineRadio2">{{__('Select Input')}}</label>
                </div>
                <div class="form-check form-check-inline">
        ...
        <div class="form-group">
            ...
            <div class="">
                <input type="text" class="form-control" name="label" value="" placeholder="Nom personnalisé">
            </div>
        ...
        <div class="form-group" v-if="placeholdershow">
            ...
            <div class="">
                <input type="text" class="form-control" name="placeholder" value="" placeholder="Espace réservé ">
            </div>
        ...
        <div class="form-group" v-if="counter > 0" id="optionarea">
            ...
            <button type="button" class="btn btn-success btn-sm text-white" @click="addOption()"><i class="fa fa-plus"></i> {{__('add new')}}</button>
        </div>


        <div class="form-group text-center">
            <button id="submitBtn" type="submit" class="btn btn-primary btn-sm">{{__('add new')}}</button>
        </div>
    </form>
