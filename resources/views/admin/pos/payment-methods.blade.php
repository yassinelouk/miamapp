...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Payment Method')}}</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">{{__('Payment Method')}}</div>
                </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($pmethods) == 0)
                <h3 class="text-center">{{__('NO PAYMENT METHOD FOUND')}}</h3>
              @else
                      ...
                      @foreach ($pmethods as $key => $pmethod)
                        <tr>
                          ...
                          <td class="d-flex align-items-center" >
                            <a class="btn btn-sm btn-secondary" href="#editModal" data-toggle="modal" data-pm_id="{{$pmethod->id}}" data-name="{{$pmethod->name}}" data-status="{{$pmethod->status}}">
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                              </span>
                              {{__('Edit')}}
                            </a>
                            <form class="d-inline-block" action="{{route('admin.pos.pmethod.delete')}}" method="post">
                              @csrf
