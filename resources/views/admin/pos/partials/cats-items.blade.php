                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade {{$loop->first ? 'show active' : ''}}" id="pcat{{$pcat->id}}" role="tabpanel" aria-labelledby="pcat{{$pcat->id}}-tab">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-4 col-md-2 col-sm-2 px-2 mb-3">
                                    ...
                                    @if(!empty($product->feature_image))
                                        <img class="lazy posImg" src="{{asset('assets/admin/img/placeholde-150.png')}}" data-src="{{asset('assets/front/img/product/featured/' . $product->feature_image)}}" alt="" width="100%">
                                    @endif
