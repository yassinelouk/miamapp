...
@endif">
    ...
    @endif" id="webContents">
        <ul class="nav nav-collapse">
                    ...
                    <ul class="nav nav-collapse subnav">
                        ...
                        <li class="@if(request()->path() == 'admin/herosection/video') active @endif">
                            <a href="{{route('admin.herosection.video') . '?language=' . $default->code}}">
                                <span class="sub-item">{{__('Video Link')}}</span>
                            </a>
                        </li>
                    </ul>
                    </div>
            ...
            @elseif(request()->is('admin/job/applications')) selected
            @endif">
                ...
                @elseif(request()->path() == 'admin/jobs') show
                @elseif(request()->is('admin/job/*/edit')) show
                @elseif(request()->path() == 'admin/job/applications') show
                @endif" id="career">
                    <ul class="nav nav-collapse subnav">
                        <li class="
                        ...
                        <li class="
                        @if(request()->path() == 'admin/job/applications') active
                        @endif">
                            <a href="{{route('admin.job.applications') . '?language=' . $default->code}}">
            ...
            @endif">
              <a data-toggle="collapse" href="#pages">
                <span class="sub-item">{{__('Custom Pages')}}</span>
                <span class="caret"></span>
              </a>
              <div class="collapse
