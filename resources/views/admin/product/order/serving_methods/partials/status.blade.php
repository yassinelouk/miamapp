    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{__('Status')}} ({{__($sm->name)}})</h5>
        ...
        <div class="modal-body">
            <form action="{{route('admin.product.servingMethodStatus')}}" method="POST" id="servingMethodStatus{{$sm->id}}">
                ...
                <div class="form-group">
                    <label class="form-label">{{__('Website Menu')}}</label>
                ...
                <div class="form-group">
                    <label class="form-label">{{__('QR Menu')}}</label>
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
        ...
        <div class="modal-footer justify-content-center">
            <button type="submit" class="btn btn-success" form="servingMethodStatus{{$sm->id}}">{{__('Submit')}}</button>
