    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{__('Edit')}}: ({{__($sm->name)}})</h5>
        ...
        <div class="modal-body">
            <form action="{{route('admin.product.servingMethodUpdate')}}" method="POST" id="editForm{{$sm->id}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="serial_number" placeholder="{{__('Serial Number')}}" autocomplete="off" value="{{$sm->serial_number}}">
                    <p class="text-warning mb-0">{{__("The higher the 'serial number' is, the later is 'serving method' will be shown")}}.</p>
        ...
        <div class="modal-footer justify-content-center">
            <button type="submit" class="btn btn-success" form="editForm{{$sm->id}}">{{__('Save')}}</button>
