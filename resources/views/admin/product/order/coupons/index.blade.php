    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card-title d-inline-block">{{__('Coupon')}}</div>
                </div>
                        ...
                        @foreach ($coupons as $coupon)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <h3 class="d-inline-block badge badge-warning px-4">{{__('Pending')}}</h3>
                                    @else
                                        @if ($now->lessThan($end))
                                        <h3 class="d-inline-block badge badge-success px-4">{{__('Active')}}</h3>
                                        @else
                                        <h3 class="d-inline-block badge badge-danger px-4">{{__('Expired')}}</h3>
                                        @endif
                                    @endif
                                </td>
                                <td>
                                ...
                                <td class="d-flex align-items-center" >
                                    <a href="{{route('admin.coupon.edit', $coupon->id)}}" class="btn btn-warning btn-sm">{{__('Edit')}}</a>
                                    <form class="d-inline-block" action="{{route('admin.coupon.delete')}}" method="POST">
                                        @csrf
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="value" value="" placeholder="{{__('Discount')}}..." autocomplete="off">
            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" name="start_date" value="" placeholder="{{__('Start Date')}}..." autocomplete="off">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" name="end_date" value="" placeholder="{{__('End Date')}}..." autocomplete="off">
            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="minimum_spend" value="" placeholder="{{__('Minimum Spend')}}" autocomplete="off">
