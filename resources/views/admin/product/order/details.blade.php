       ...
       <div class="card">
          <div class="card-header">
             <div class="card-title d-flex justify-content-between">
                 ...
                 <span>{{__('Token No')}}. {{$order->token_no}}</span>
                 @endif
             </div>
          ...
          <div class="card-body pt-5 pb-5">
             <div class="payment-information">
                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        <strong>{{__('Fidelity points')}} :</strong>
                    </div>
                    <div class="col-lg-6">
                        {{$order->currency_symbol_position == 'left' ? $order->currency_symbol : ''}} {{$order->fidelity_discount}} {{$order->currency_symbol_position == 'right' ? $order->currency_symbol : ''}}
                ...
                @endif
                 ...
                 <div class="row mb-2">
                     ...
                     <div class="col-lg-6">
                         ...
                         <span class="badge badge-danger">{{__(ucfirst(convertUtf8($order->payment_status)))}}  </span>
                         @else
                         <span class="badge badge-success">{{__(ucfirst(convertUtf8($order->payment_status)))}}  </span>
                         @endif
                     </div>
                 </div>
          ...
          <div class="table-responsive product-list">
             <table class="table table-bordered">
                ...
                <tbody>
                   ...
                   <tr>
                      <td>{{$key+1}}</td>
                      <td>@if(!empty($item->image))<img src="{{asset('assets/front/img/product/featured/'.$item->image)}}" alt="product" width="100">@endif</td>
                      <td>
                          ...
                          @endif
                         @if (!empty($item["notes"]))
                            <p class="mb-0"><strong class="mr-3">{{__("Comment")}}: </strong> {{$item["notes"]}}</p>
                        @endif
                      </td>
                      <td>
