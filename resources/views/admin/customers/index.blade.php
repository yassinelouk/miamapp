    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card-title d-inline-block">{{__('Customers')}}</div>
                    </div>
                    <div class="col-lg-3">
                        <form action="{{url()->full()}}">
                            <input type="text" class="form-control" name="term" placeholder="{{__('Search by')}} {{__('Phone')}} / {{__('Name')}}" value="{{request()->input('term')}}">
                        </form>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center" >
                                            <a class="btn btn-secondary btn-sm " href="#editModal" data-toggle="modal" data-customer_id="{{$customer->id}}" data-name="{{$customer->name}}" data-phone="{{$customer->phone}}" data-email="{{$customer->email}}" data-address="{{$customer->address}}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxForm" class="modal-form create" action="{{route('admin.customer.store')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone" value="" placeholder="{{__('Phone')}}...">
                        <p id="errphone" class="mb-0 text-danger em"></p>
                    </div>
                    <div class="form-group">
                        <label for="">{{__('Email Address')}} </label>
                        <input type="text" class="form-control" name="email" value="" placeholder="{{__('Email Address')}}">
            ...
            <div class="modal-footer">
                ...
                <button id="submitBtn" type="button" class="btn btn-primary">{{__('add new')}}</button>
            </div>
        </div>
    </div>
</div>
