...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{__('Drag & Drop Menu Builder')}}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Drag & Drop Menu Builder')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card border-primary mb-3">
                        <div class="card-header bg-primary text-light">{{__('Choose from Redymade Menus')}}</div>
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">{{__('Menu 1')}} <a data-text="{{__('Menu 1')}}" data-type="menu_1" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                <li class="list-group-item">{{__('Menu 2')}} <a data-text="{{__('Menu 2')}}" data-type="menu_2" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>

                                <li class="list-group-item">{{__('Items')}} <a data-text="{{__('Items')}}" data-type="items" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                <li class="list-group-item">{{__('Cart')}} <a data-text="{{__('Cart')}}" data-type="cart" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                <li class="list-group-item">{{__('Checkout')}} <a data-text="{{__('Checkout')}}" data-type="checkout" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>

                                @foreach ($pages as $page)
                                    <li class="list-group-item">{{$page->name}} <a data-text="{{$page->name}}" data-type="{{$page->id}}" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                @endforeach

                                <li class="list-group-item">{{__('Career')}} <a data-text="{{__('Career')}}" data-type="career" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                <li class="list-group-item">{{__('Team Members')}} <a data-text="{{__('Team Members')}}" data-type="team" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                <li class="list-group-item">{{__('Gallery')}} <a data-text="{{__('Gallery')}}" data-type="gallery" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                ...
                                <li class="list-group-item">{{__('Blogs')}} <a data-text="{{__('Blogs')}}" data-type="blogs" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                                ...
                                <li class="list-group-item">{{__('Reservation')}} <a data-text="{{__('Reservation')}}" data-type="reservation" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card border-primary mb-3">
                        <div class="card-header bg-primary text-light">{{__('Add / Edit Menu')}}</div>
                        <div class="card-body">
                ...
                <div class="col-lg-4">
                    <div class="card mb-3">
                        <div class="card-header bg-primary text-light">{{__('Website Menu')}}</div>
                        <div class="card-body">
            ...
            <div class="form">
                <div class="form-group from-show-notify row">
                    <div class="col-12 text-center">
                        <button id="btnOutput" class="btn btn-success">{{__('Update')}}</button>
                    </div>
                </div>
            </div>
        </div>
