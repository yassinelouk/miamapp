...
<div class="page-header">
   ...
   <ul class="breadcrumbs">
      ...
      <li class="nav-item">
         <a href="{{url()->previous()}}">{{__('Customers')}}</a>
      </li>
      <li class="separator">
         <i class="flaticon-right-arrow"></i>
      </li>
   ...
   <a href="{{ url()->previous() }}" class="btn-md btn btn-primary ml-auto">{{__('back')}}</a>
</div>
<div class="row">
   <div class="col-md-12">
            <div class="row">
      ...
      <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{__('Orders')}} [{{ $user->username}}]</h4>
        </div>
        <div class="card-body">
                ...
                <table class="table table-striped mt-3">
                   ...
                   <tbody>
                      ...
                      <tr>
                         ...
                         <td>
                            <a href="{{route('admin.product.details',$order->id)}}" class="btn btn-primary btn-sm editbtn"><i class="fas fa-eye"></i> {{__('Details')}}</a>
                         </td>
                      </tr>
                      @endforeach
                   </tbody>
