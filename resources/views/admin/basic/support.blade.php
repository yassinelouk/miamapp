            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control ltr" name="support_email" value="{{$abs->support_email}}" placeholder="{{__('Email Address')}}...">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="support_phone" value="{{$abs->support_phone}}" placeholder="{{__('Phone')}}...">
