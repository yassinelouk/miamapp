          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                <div class="alert alert-warning text-center py-4 normal" role="alert">
                    <strong>{{__('This mail address will be used to receive all mails from clients / buyers / inquirier')}}.</strong>
                </div>
                @csrf
