    ...
    <div class="col-md-12">
      <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">{{__('Update Maintenance Page & Mode')}}</div>
          </div>
              ...
              <div class="col-lg-6 offset-lg-3">
                <form  action="{{route('admin.maintainance.update')}}" method="post" enctype="multipart/form-data" id="maintenanceForm">
                  ...
                  <div class="form-group">
                    ...
                    <p class="text-warning">{{__("Maintenance Mode won't be applied to these IP Addresses")}}</p>
                  </div>
          ...
          <div class="card-footer">
            <div class="form-group from-show-notify row">
              <div class="col-12 text-center">
                <button type="submit"  class="btn btn-success" form="maintenanceForm">{{__('Update')}}</button>
              </div>
            </div>
          </div>
