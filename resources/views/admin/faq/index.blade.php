    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">{{__('FAQ')}}</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form create" action="{{route('admin.faq.store')}}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="question" value="" placeholder="{{__('Question')}}...">
              <p id="errquestion" class="mb-0 text-danger em"></p>
            </div>
            <div class="form-group">
              <label for="">{{__('Answer')}} **</label>
              <textarea class="form-control" name="answer" rows="5" cols="80" placeholder="{{__('Answer')}}..."></textarea>
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>{{__('The higher the serial number is, the later the FAQ will be shown')}}.</small></p>
            </div>
          </form>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxEditForm" class="" action="{{route('admin.faq.update')}}" method="POST">
            ...
            <div class="form-group">
              <label for="">{{__('Question')}} **</label>
              <input id="inquestion" type="text" class="form-control" name="question" value="" placeholder="{{__('Question')}}...">
              <p id="eerrquestion" class="mb-0 text-danger em"></p>
            </div>
            <div class="form-group">
              <label for="">{{__('Answer')}} **</label>
              <textarea id="inanswer" class="form-control" name="answer" rows="5" cols="80" placeholder="{{__('Answer')}}..."></textarea>
