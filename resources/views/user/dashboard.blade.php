                            ...
                            <div class="account-info">
                                ...
                                <div class="main-info">
                                    ...
                                    <ul class="list">
                                        ...
                                        <li><span>{{__('Fidelity points')}}:</span></li>
                                    ...
                                    <ul class="list">
                                        ...
                                        <li>{{convertUtf8($user->fidelity_points)}}</li>
                            ...
                            <div class="main-info">
                                <div class="main-table">
                                    <div class="table-responsiv">
                                        <table id="example" class="dataTables_wrapper dt-responsive table-striped dt-bootstrap4 w-100" style="border-spacing: 1rem 5px;border-collapse:separate;">
                                            <thead>
                                                <tr>
